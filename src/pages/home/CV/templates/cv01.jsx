  ...
  return (
    <div className="relative font-sans">
      ...
      <button
        ...
        className="fixed top-10 right-10 z-50 bg-blue-600 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-blue-700 transition duration-300 print:hidden"
      >
        Download as PDF
      </button>
      <div ref={cvRef} className="w-[21cm] min-h-[29.7cm] mx-auto bg-white shadow-md p-6 print:p-0 print:shadow-none">
        {/* Header */}
        ...
        <div className="flex flex-row">
          ...
          <div className="w-2/5 pr-4 bg-gray-100 p-4 rounded-lg print:break-inside-avoid mb-4">
            ...
            <div className="mb-4">
              <h2 className="text-lg font-bold text-gray-800 flex items-center leading-none">
                <FaUserCircle className="mr-2 text-black align-middle" style={{ fontSize: 22, minWidth: 22, minHeight: 22 }} />
            ...
            <div className="mb-4">
              <h2 className="text-lg font-bold text-gray-800 flex items-center leading-none">
                <FaUserCheck className="mr-2 text-black align-middle" style={{ fontSize: 22, minWidth: 22, minHeight: 22 }} />
            ...
            <div className="mb-4">
              <h2 className="text-lg font-bold text-gray-800 flex items-center leading-none">
                <FaTasks className="mr-2 text-black align-middle" style={{ fontSize: 22, minWidth: 22, minHeight: 22 }} />
          ...
          <div className="w-3/5 pl-4 print:break-inside-avoid mb-4">
            ...
            <div className="mb-4">
              <h2 className="text-lg font-bold text-gray-800 flex items-center leading-none">
                <FaBook className="mr-2 text-black align-middle" style={{ fontSize: 22, minWidth: 22, minHeight: 22 }} />
            ...
            <div className="mb-4">
              <h2 className="text-lg font-bold text-gray-800 flex items-center leading-none">
                <FaBriefcase className="mr-2 text-black align-middle" style={{ fontSize: 22, minWidth: 22, minHeight: 22 }} />
            ...
            <div className="print:break-after-page">
              <h2 className="text-lg font-bold text-gray-800 flex items-center leading-none">
                <FaProjectDiagram className="mr-2 text-black align-middle" style={{ fontSize: 22, minWidth: 22, minHeight: 22 }} />
